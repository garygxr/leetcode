...
//////// 输入：s = "?zs"
////////输出："azs"
////////解释：该示例共有 25 种解决方案，从 "azs" 到 "yzs" 都是符合题目要求的。只有 "z" 是无效的修改，因为字符串 "zzs" 中有
//连续
////重复
//////的两
////////个 'z' 。 
...
//////// 输入：s = "ubv?w"
////////输出："ubvaw"
////////解释：该示例共有 24 种解决方案，只有替换成 "v" 和 "w" 不符合题目要求。因为 "ubvvw" 和 "ubvww" 都包含连续重复的字
//符。
////
//////// 
////////
...
public class ReplaceAllSToAvoidConsecutiveRepeatingCharacters {
    public static void main(String[] args) {
        ...
        String s = solution.modifyString("??sz");
